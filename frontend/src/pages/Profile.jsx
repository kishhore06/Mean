...
import { User as UserIcon, Settings, Calendar, AtSign, Bio, FileText, ChevronLeft, LogOut } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
            <div>
              ...
              <div className="flex items-center justify-center md:justify-start space-x-4 text-gray-500 text-sm">
                <span className="flex items-center"><AtSign className="w-3.5 h-3.5 mr-1.5" />{user.email}</span>
              </div>
            </div>
          ...
          {user.bio ? (
             ...
             <p className="text-gray-400 font-serif italic text-lg leading-relaxed max-w-2xl mb-8">
               No bio written yet. Share a bit about yourself with the world!
             </p>
          )}
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-12">
            <div className="text-center md:text-left">
              ...
              <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Stories Written</span>
            </div>
            <div className="text-center md:text-left">
              <span className="block text-2xl font-bold text-black">{stats.totalViews}</span>
              <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">Total Reads</span>
            </div>
            <div className="text-center md:text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Link 
          to="/my-blogs" 
          className="group flex items-center justify-between p-8 bg-gray-50 rounded-2xl hover:bg-white hover:shadow-2xl hover:shadow-black/5 border border-transparent hover:border-gray-100 transition-all"
        >
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">View and manage your posts</p>
            </div>
          </div>
        ...
        <button 
          onClick={logout}
          className="group flex items-center justify-between p-8 bg-red-50/30 rounded-2xl hover:bg-white hover:shadow-2xl hover:shadow-black/5 border border-transparent hover:border-red-100 transition-all"
        >
          <div className="flex items-center space-x-6">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-red-400">Exit your account safely</p>
            </div>
          </div>
